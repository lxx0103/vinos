    ...
    $.fn.prettyPhoto = function(pp_settings) {
        ...
        <div class="pp_content"> \
         ...
         <div class="pp_fade"> \
          ...
          <div class="pp_details"> \
           ...
           <div class="bodega_link"><a href="http://www.baidu.com" target="_blank" id="bodega_link_a">Página ofical</a></div> \
     ...
     <div class="pp_overlay"></div>',
        ...
        $.prettyPhoto.open = function(event) {
            $pp_pic_holder.find('#bodega_link_a').attr('href', 'http://' + theLink);
            ...
            $pp_pic_holder.fadeIn(function() {
                ...
                case 'image':
                    ...
                    $pp_pic_holder.find('#bodega_link_a').attr('href', 'http://' + pp_links[set_position]);
