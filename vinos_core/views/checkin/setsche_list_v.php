...
$('.add_rule').on('click', function(){
    ...
    $('#schedule_edit_form').find('#dept_id').val(0);
    ...
    $.ajax({ 
        ...
        success: function(result){
            if(result.status == 1){
                ...
                $('#schedule_edit_form').find('#dept_id').val(result.data.dept_id);
...
$('#save_rule').on('click', function(){
    $.ajax({ 
        url: "/checkin/setsche/save",
        data: {"dept_id":$("#dept_id").val(), "sche_id":$("#sche_id").val(), "start_date":$("#start_date").val(), "end_date":$("#end_date").val(), "start_time":$("#start_time").val(), "end_time":$("#end_time").val(), "is_enable":$("#is_enable").val(), "rule_id":$("#rule_id").val()},
        dataType: 'json',
        type: 'POST',
        success: function(result){            
            if(result.status == 1){
