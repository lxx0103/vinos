...
<link rel="stylesheet" href="/assets/admin/css/bootstrap-datetimepicker.css" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="#">Vionsinfo后台管理系统</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li class=""><a title="" href="#"><i class="icon icon-user"></i>  <span class="text"><?=$user['username']?>(管理员)</span></a></li>
    <li class=""><a title="" href="/admin/logout"><i class="icon icon-share-alt"></i><span class="text">退出登录</span></a></li>
  </ul>
</div>
