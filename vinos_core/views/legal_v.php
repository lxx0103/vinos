<?php require_once(VIEWPATH.'common/head_v.php');?>       
        ...
        <div id="outerbeforecontent">
        	<div id="beforecontent">
            	<section id="beforethecontent">
					<div class="intro-l">
                        <h1 class="pagetitle">Únete a nosotros</h1>
                    </div>
                    <div class="intro-r">
                    	La puerta de entrada al mercado con mayor potencial del mundo<br />
						<h2>EL MEJOR SERVICIO EN CHINO</h2>
                    </div>
                    <div class="clear"></div>
                </section>
            </div>
        ...
        <div id="outermain">
        	...
        	<section id="mainthecontent">
				...
				<article>
                    <div style="display: block; height: 1380px;width: 940px; float: left;margin-bottom: 20px;">
                        ...
                        Ser usuario de la web de (www.vinosinfo.com) implica que reconoce haber leído y aceptado las presentes condiciones y lo que las extienda la normativa legal aplicable en esta materia. Si por el motivo que fuere no está de acuerdo con estas condiciones no continúe usando esta web.<br />
                        Cualquier tipo de notificación y/o reclamación solamente será válida por notificación escrita y/o correo certificado.</div>

                        <h4>RESPONSABILIDADES</h4>
                        <div style="margin-bottom: 30px;">Dongteng Wang no se hace responsable de la información y contenidos almacenados en foros, redes sociales o cualesquier otro medio que permita a terceros publicar contenidos de forma independiente en la página web del prestador.<br />
                        Sin embargo, teniendo en cuenta los art. 11 y 16 de la LSSI-CE, Dongteng Wang se compromete a la retirada o en su caso bloqueo de aquellos contenidos que pudieran afectar o contravenir la legislación nacional o internacional, derechos de terceros o la moral y el orden público.<br />
                        ...
                        Así mismo, Dongteng Wang se reserva el derecho a actualizar, modificar o eliminar la información contenida en su página web, así como la configuración o presentación del mismo, en cualquier momento sin asumir alguna responsabilidad por ello.<br />
                        Le comunicamos que cualquier precio que pueda ver en nuestra web será solamente orientativo. Si el usuario desea saber con exactitud el precio o si el producto en el momento actual cuenta con alguna oferta de la cual se puede beneficiar ha de acudir a alguna de las personas comerciales con las que cuenta www.vinosinfo.com</div>

                        <h4>PROPIEDAD INTELECTUAL E INDUSTRIAL</h4>
                        <div style="margin-bottom: 30px;">Dongteng Wang es titular de todos los derechos sobre el software de la publicación digital así como de los derechos de propiedad industrial e intelectual referidos a los contenidos que se incluyan.<br />
                        Ningún material publicado en esta web podrá ser reproducido, copiado o publicado sin el consentimiento por escrito de Dongteng Wang.<br />
                        Toda la información que se reciba en la web, como comentarios, sugerencias o ideas, se considerará cedida a Dongteng Wang de manera gratuita. No debe enviarse información que NO pueda ser tratada de este modo.<br />
                        Todos los productos de estas páginas que NO son propiedad de Dongteng Wang, son marcas registradas de sus respectivos propietarios y son reconocidas como tales por nuestra empresa. Solamente aparecen en la web de Dongteng Wang a efectos de promoción y de recopilación de información. Estos propietarios pueden solicitar la modificación o eliminación de la información que les pertenece.</div>

                        <h4>LEY APLICABLE Y JURISDICCIÓN</h4>
                        <div style="margin-bottom: 30px;">Las presentes condiciones generales se rigen por la legislación española. Para cualquier litigio que pudiera surgir relacionado con el sitio web o la actividad que en él se desarrolla serán competentes Juzgados de Madrid, renunciando expresamente el usuario a cualquier otro fuero que pudiera corresponderle.</div>
                        ...
                        En todo caso las cookies tienen un carácter temporal con la única finalidad de hacer más eficaz su transmisión ulterior. En ningún caso se utilizará cookies para recoger información de carácter personal.</div>
