...
class Menu extends MY_Controller
{
    ...
    {
        $menus = $this->Menu_m_b->get_all_menu(false);
        $sorted_menus = array();
        ...
        // echo '<pre>';
        // print_r($menu_level);
        $this->load->view('admin/menu_list_v', $this->data);
    }
    ...
    public function one()
    {
        ...
        $role = $this->Menu_m_b->get_menu_by_id($menu_id, false);
    ...
    public function save()
    {
        ...
        $save = $this->Menu_m_b->save($menu_id, $name, $dir, $controller, $method, $parent_id, $is_hidden, $is_enable, $this->session->username);
